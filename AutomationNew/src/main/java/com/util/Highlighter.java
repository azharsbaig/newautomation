...
public class Highlighter {
	...
	public static void getcolor(WebDriver driver, WebElement element) {
		...
		//js.executeScript("arguments[0].setAttribute('style','background:lightorange; border: 6px solid red;');", element);
		js.executeScript("arguments[0].setAttribute('style','background:lightblue; border:5px solid red;');",element);
	}
	...
	public static void getcolor(WebDriver driver, WebElement element, String color) {// OOPs ==> Polymorphism ==> Compile time
		...
		//js.executeScript("arguments[0].setAttribute('style', 'background:lightorange; border: 6px solid " + color + ";');",
				//element);
		js.executeScript("arguments[0].setAttribute('style','background:lightblue; border:5px solid "+color+";');",element);
	}	
